...
export const repositoryStyles = {
  ...
  controls: {
    ...
    searchInput: "w-full pl-10 pr-4 py-2 bg-[#111111] border border-[#D9D9D9] rounded-lg focus:ring-2 focus:ring-[#0000FF] focus:border-[#0000FF] text-[#D9D9D9] placeholder-[#D9D9D9]",
  ...
  grid: {
    ...
    card: {
      base: "relative bg-[#18181b] border border-[#D9D9D9] rounded-lg p-4 hover:shadow-lg hover:bg-[#222222] transition-all",
  ...
  modal: {
    ...
    container: "bg-[#111111] border border-[#D9D9D9] rounded-lg p-6 w-full max-w-md mx-4 max-h-[90vh] overflow-y-auto",
  ...
  form: {
    ...
    input: "w-full bg-[#111111] border border-[#D9D9D9] rounded-lg px-3 py-2 focus:ring-2 focus:ring-[#0000FF] focus:border-[#0000FF] text-[#D9D9D9] placeholder-[#D9D9D9]",
    textarea: "w-full bg-[#111111] border border-[#D9D9D9] rounded-lg px-3 py-2 focus:ring-2 focus:ring-[#0000FF] focus:border-[#0000FF] text-[#D9D9D9] placeholder-[#D9D9D9]",
    fileInputWrapper: "flex items-center space-x-3 mt-2 mb-2",
    fileInputHidden: "hidden",
    fileInputLabel: "flex items-center gap-2 px-4 py-3 bg-[#18181b] border-2 border-dashed border-[#F1C232] rounded-lg cursor-pointer hover:bg-[#222222] text-[#F1C232] font-semibold transition-colors duration-150 focus:ring-2 focus:ring-[#F1C232] focus:border-[#F1C232]",
    fileName: "text-sm text-[#E5E5E5] ml-2",
    helpText: "text-xs text-[#BDBDBD] mt-1",
    imagePreview: "w-full h-32 object-cover rounded-lg border-2 border-[#F1C232] mt-2 shadow-md bg-[#111111]"
  },
  
  // Buttons
  buttons: {
    cancel: "px-4 py-2 text-[#D9D9D9] bg-[#111111] border border-[#D9D9D9] rounded-lg hover:bg-[#222222]",
