            ...
            <main className="w-full h-screen flex self-center place-content-center place-items-center bg-black">
                <div className="w-96 text-[#D9D9D9] space-y-5 p-4 shadow-xl border border-[#D9D9D9] rounded-xl bg-[#111111]">
                    <div className="text-center mb-6">
                        <div className="mt-2">
                            <h3 className="text-[#F1C232] text-xl font-semibold sm:text-2xl">Create a New Account</h3>
                        </div>
                    </div>
                    <form onSubmit={onSubmit} className="space-y-4">
                        <div>
                            <label className="text-sm text-[#D9D9D9] font-bold">Email</label>
                            <input
                                type="email"
                                autoComplete="email"
                                required
                                ...
                                className="w-full mt-2 px-3 py-2 text-[#D9D9D9] bg-[#000000] outline-none border border-[#D9D9D9] focus:border-[#F1C232] shadow-sm rounded-lg transition duration-300"
                            />
                        </div>

                        <div>
                            <label className="text-sm text-[#D9D9D9] font-bold">Username</label>
                            <input
                                type="username"
                        ...
                        <div>
                            <label className="text-sm text-[#D9D9D9] font-bold">Password</label>
                            <input
                        ...
                        <div>
                            <label className="text-sm text-[#D9D9D9] font-bold">Confirm Password</label>
                            <input
                                disabled={isRegistering}
                                type="password"
                                autoComplete="off"
                        ...
                        {errorMessage && (
                         ...
                         {successMessage && (
                             <div role="alert" className='text-green-400 font-semibold text-sm p-3 bg-green-900 border border-green-700 rounded-md'>
                                {successMessage}
                            </div>
                        )}
                        ...
                        <button
                            type="submit"
                            disabled={isRegistering}
                            className={`w-full px-4 py-2 text-white font-medium rounded-lg ${isRegistering ? 'bg-gray-600 cursor-not-allowed' : 'bg-[#F1C232] hover:bg-[#0000FF] hover:text-[#D9D9D9] transition duration-300'}`}
                        >
                            {isRegistering ? 'Signing Up...' : 'Sign Up'}
                        </button>
                        <div className="text-sm text-center text-[#D9D9D9]">
                            Already have an account? {' '}
                            <Link to={'/login'} className="text-center text-sm hover:underline font-bold text-[#F1C232]">Continue</Link>
                        </div>
                    </form>
                </div>
            </main>
